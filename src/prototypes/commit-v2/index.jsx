...
export const SCREEN_GROUPS = [
  {
    ...
    screens: [
      { id: 'commit-n0202', label: 'Default' },
      { id: 'commit-v2-button-animation', label: 'Commit button animation' },
    ],
  },
];

export default function CommitV2Screen({ screenId }) {
  const [loading, setLoading] = useState(false);
  ...
  if (screenId === 'commit-v2-button-animation') {
    return (
